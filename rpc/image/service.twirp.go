...
const ImagePathPrefix = "/twirp/com.rynop.twirpl.image.Image/"

func (s *imageServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "com.rynop.twirpl.image")
	...
	switch req.URL.Path {
	case "/twirp/com.rynop.twirpl.image.Image/CreateGiphy":
