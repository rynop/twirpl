...
/*
Package blog is a generated twirp stub package.
...
const BlogPathPrefix = "/twirp/com.rynop.twirpl.blog.Blog/"

func (s *blogServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "com.rynop.twirpl.blog")
	...
	switch req.URL.Path {
	case "/twirp/com.rynop.twirpl.blog.Blog/Subscribe":
