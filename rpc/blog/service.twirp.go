...
const BlogPathPrefix = "/twirp/com.rynop.coolapi.blog.Blog/"

func (s *blogServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "com.rynop.coolapi.blog")
	...
	switch req.URL.Path {
	case "/twirp/com.rynop.coolapi.blog.Blog/Subscribe":
...
var twirpFileDescriptor0 = []byte{
	...
	0x29, 0x55, 0x48, 0x46, 0x0f, 0xbb, 0x7d, 0x7a, 0x20, 0xcb, 0xa4, 0xf0, 0xca, 0x3a, 0x71, 0x46,
	0xb1, 0x43, 0x05, 0x93, 0xd8, 0xc0, 0x8e, 0x37, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x4b, 0x20,
	0x91, 0x26, 0xd6, 0x00, 0x00, 0x00,
}
